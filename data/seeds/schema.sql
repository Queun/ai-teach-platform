...
\restrict B2kYniFRbfKl6ZP9KC55kEEzr03rwdh18kH8WUoSCofPRzbtmjZHgAX6bvlNHq0
...
CREATE TABLE public.ai_tools (
    ...
    tutorial_url character varying(255),
    user_rating numeric(10,2),
    popularity integer,
    features jsonb,
    pros jsonb,
    cons jsonb,
...
--
-- Name: comments_parent_lnk; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: comments_users_permissions_user_lnk; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.comments_users_permissions_user_lnk (
    id integer NOT NULL,
    comment_id integer,
    user_id integer,
    comment_ord double precision
...
--
-- Name: comments_users_permissions_user_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.comments_users_permissions_user_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: comments_users_permissions_user_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.comments_users_permissions_user_lnk_id_seq OWNED BY public.comments_users_permissions_user_lnk.id;


--
-- Name: edu_resources; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.edu_resources (
    ...
    author_school character varying(255),
...
--
-- Name: edu_resources_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.edu_resources_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: edu_resources_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.edu_resources_id_seq OWNED BY public.edu_resources.id;
...
CREATE TABLE public.news_articles (
    ...
    author_name character varying(255),
    author_bio character varying(255),
    views integer,
    shares integer,
    is_breaking boolean,
    is_featured boolean,
...
--
-- Name: user_actions_users_permissions_user_lnk; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.user_actions_users_permissions_user_lnk (
    id integer NOT NULL,
    user_action_id integer,
    user_id integer,
    user_action_ord double precision
);


--
-- Name: user_actions_users_permissions_user_lnk_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.user_actions_users_permissions_user_lnk_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: user_actions_users_permissions_user_lnk_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.user_actions_users_permissions_user_lnk_id_seq OWNED BY public.user_actions_users_permissions_user_lnk.id;
...
--
-- Name: comments_parent_lnk id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: comments_users_permissions_user_lnk id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments_users_permissions_user_lnk ALTER COLUMN id SET DEFAULT nextval('public.comments_users_permissions_user_lnk_id_seq'::regclass);


--
-- Name: edu_resources id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.edu_resources ALTER COLUMN id SET DEFAULT nextval('public.edu_resources_id_seq'::regclass);
...
--
-- Name: user_actions_users_permissions_user_lnk id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions_users_permissions_user_lnk ALTER COLUMN id SET DEFAULT nextval('public.user_actions_users_permissions_user_lnk_id_seq'::regclass);
...
--
-- Name: comments_parent_lnk comments_parent_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk comments_parent_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: comments_users_permissions_user_lnk comments_users_permissions_user_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments_users_permissions_user_lnk
    ADD CONSTRAINT comments_users_permissions_user_lnk_pkey PRIMARY KEY (id);


--
-- Name: comments_users_permissions_user_lnk comments_users_permissions_user_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments_users_permissions_user_lnk
    ADD CONSTRAINT comments_users_permissions_user_lnk_uq UNIQUE (comment_id, user_id);


--
-- Name: edu_resources edu_resources_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.edu_resources
    ADD CONSTRAINT edu_resources_pkey PRIMARY KEY (id);
...
--
-- Name: user_actions_users_permissions_user_lnk user_actions_users_permissions_user_lnk_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions_users_permissions_user_lnk
    ADD CONSTRAINT user_actions_users_permissions_user_lnk_pkey PRIMARY KEY (id);


--
-- Name: user_actions_users_permissions_user_lnk user_actions_users_permissions_user_lnk_uq; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions_users_permissions_user_lnk
    ADD CONSTRAINT user_actions_users_permissions_user_lnk_uq UNIQUE (user_action_id, user_id);
...
--
-- Name: ai_tools_created_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ai_tools_created_by_id_fk ON public.ai_tools USING btree (created_by_id);


--
-- Name: ai_tools_documents_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ai_tools_documents_idx ON public.ai_tools USING btree (document_id, locale, published_at);


--
-- Name: ai_tools_updated_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ai_tools_updated_by_id_fk ON public.ai_tools USING btree (updated_by_id);
...
--
-- Name: comments_documents_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk_fk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk_ifk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk_oifk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX comments_parent_lnk_oifk ON public.comments_parent_lnk USING btree (comment_ord);
...
--
-- Name: comments_users_permissions_user_lnk_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX comments_users_permissions_user_lnk_fk ON public.comments_users_permissions_user_lnk USING btree (comment_id);


--
-- Name: comments_users_permissions_user_lnk_ifk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX comments_users_permissions_user_lnk_ifk ON public.comments_users_permissions_user_lnk USING btree (user_id);


--
-- Name: comments_users_permissions_user_lnk_oifk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX comments_users_permissions_user_lnk_oifk ON public.comments_users_permissions_user_lnk USING btree (comment_ord);


--
-- Name: edu_resources_created_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX edu_resources_created_by_id_fk ON public.edu_resources USING btree (created_by_id);


--
-- Name: edu_resources_documents_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX edu_resources_documents_idx ON public.edu_resources USING btree (document_id, locale, published_at);


--
-- Name: edu_resources_updated_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX edu_resources_updated_by_id_fk ON public.edu_resources USING btree (updated_by_id);
...
--
-- Name: news_articles_created_by_id_fk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: news_articles_documents_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: news_articles_updated_by_id_fk; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: user_actions_created_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_created_by_id_fk ON public.user_actions USING btree (created_by_id);


--
-- Name: user_actions_documents_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_documents_idx ON public.user_actions USING btree (document_id, locale, published_at);


--
-- Name: user_actions_updated_by_id_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_updated_by_id_fk ON public.user_actions USING btree (updated_by_id);


--
-- Name: user_actions_users_permissions_user_lnk_fk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_users_permissions_user_lnk_fk ON public.user_actions_users_permissions_user_lnk USING btree (user_action_id);


--
-- Name: user_actions_users_permissions_user_lnk_ifk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_users_permissions_user_lnk_ifk ON public.user_actions_users_permissions_user_lnk USING btree (user_id);


--
-- Name: user_actions_users_permissions_user_lnk_oifk; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_actions_users_permissions_user_lnk_oifk ON public.user_actions_users_permissions_user_lnk USING btree (user_action_ord);
...
--
-- Name: ai_tools ai_tools_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_tools
    ADD CONSTRAINT ai_tools_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: ai_tools ai_tools_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ai_tools
    ADD CONSTRAINT ai_tools_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;
...
--
-- Name: comments_parent_lnk comments_parent_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: comments_parent_lnk comments_parent_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: comments_users_permissions_user_lnk comments_users_permissions_user_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments_users_permissions_user_lnk
    ADD CONSTRAINT comments_users_permissions_user_lnk_fk FOREIGN KEY (comment_id) REFERENCES public.comments(id) ON DELETE CASCADE;


--
-- Name: comments_users_permissions_user_lnk comments_users_permissions_user_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.comments_users_permissions_user_lnk
    ADD CONSTRAINT comments_users_permissions_user_lnk_ifk FOREIGN KEY (user_id) REFERENCES public.up_users(id) ON DELETE CASCADE;


--
-- Name: edu_resources edu_resources_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.edu_resources
    ADD CONSTRAINT edu_resources_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: edu_resources edu_resources_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.edu_resources
    ADD CONSTRAINT edu_resources_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;
...
--
-- Name: news_articles news_articles_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: news_articles news_articles_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_actions user_actions_created_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions
    ADD CONSTRAINT user_actions_created_by_id_fk FOREIGN KEY (created_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: user_actions user_actions_updated_by_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions
    ADD CONSTRAINT user_actions_updated_by_id_fk FOREIGN KEY (updated_by_id) REFERENCES public.admin_users(id) ON DELETE SET NULL;


--
-- Name: user_actions_users_permissions_user_lnk user_actions_users_permissions_user_lnk_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions_users_permissions_user_lnk
    ADD CONSTRAINT user_actions_users_permissions_user_lnk_fk FOREIGN KEY (user_action_id) REFERENCES public.user_actions(id) ON DELETE CASCADE;


--
-- Name: user_actions_users_permissions_user_lnk user_actions_users_permissions_user_lnk_ifk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_actions_users_permissions_user_lnk
    ADD CONSTRAINT user_actions_users_permissions_user_lnk_ifk FOREIGN KEY (user_id) REFERENCES public.up_users(id) ON DELETE CASCADE;
...
\unrestrict B2kYniFRbfKl6ZP9KC55kEEzr03rwdh18kH8WUoSCofPRzbtmjZHgAX6bvlNHq0
