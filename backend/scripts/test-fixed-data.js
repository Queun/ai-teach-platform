...
// 测试修复后的ChatGPT数据
async function testFixedChatGPTData() {
  console.log('🔍 测试修复后的ChatGPT数据...');
  
  try {
    const chatGPTData = {
      data: {
        name: "ChatGPT",
        description: fixBlocksFormat([
          {
            type: "paragraph",
            children: [
              {
    ...
    console.log('正在发送修复后的数据到 Strapi...');
